...
public class Main {
    public static void main(String[] args){
        ...
        System.out.println("DT: " + circle.getArea() + " CV: " + circle.getPerimeter());
        System.out.println(circle.toString());

        System.out.println("------//////--------");
        System.out.println("Test Rect");
        Rectangle rectangle = new Rectangle("blue", false, 3, 4);
        System.out.println("DT: " + rectangle.getArea() + " CV: " + rectangle.getPerimeter());
        System.out.println(rectangle.toString());

        System.out.println("------//////--------");
        System.out.println("Test sqare");
        Square square = new Square(3);
        System.out.println("DT: " + square.getArea() + " CV: " + square.getPerimeter());
